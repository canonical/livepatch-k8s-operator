...
async def test_charm_integrates(ops_test: OpsTest):
    ...
    await ops_test.model.relate("self-signed-certificates:certificates", "gateway-api-integrator:certificates")
    await ops_test.model.relate("gateway-api-integrator:gateway-route", "gateway-route-configurator:gateway-route")
